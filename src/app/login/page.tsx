...
import { useGetCurrentUserQuery, usePostLoginMutation } from '../../slices/userApiSlice';
...
export default function login() {
  ...
  const { data, isError: authError, isLoading: authLaoding  } = useGetCurrentUserQuery(token);
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const { id, email, firstName, lastName, gender, image, token } = response;
